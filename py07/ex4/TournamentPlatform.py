...
class TournamentPlatform:
    ...
    def create_match(self, card1_id: str, card2_id: str) -> dict:
        """Create a match between two registered
            cards and return the result."""
    ...
    def get_leaderboard(self) -> list:
        """Return a sorted leaderboard of cards based on their ratings."""
    ...
    def generate_tournament_report(self) -> dict:
        """Generate a report summarizing the tournament statistics."""
